...
##
##  <Description>
##  <Func Name="RecNames"/> and <Func Name="RecNamesSorted"/> return a duplicate-free list of strings corresponding to the names of
##  the record components of the record <A>record</A>. The only difference is
##  <Func Name="RecNamesSorted"/> is sorted lexicographically by string.
##  <P/>
##  <Func Name="RecNames"/> is sorted by <Ref Func="RNamObj" Label="for a string"/>
